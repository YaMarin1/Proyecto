            ...
            <nav class="u-menu u-menu-dropdown u-offcanvas u-menu-1" data-responsive-from="MD">
                ...
                <div class="u-custom-menu u-nav-container">
                    <ul class="u-nav u-unstyled u-nav-1">
                        <li class="u-nav-item"><a class="u-button-style u-nav-link u-text-active-white u-text-hover-white" href="ofertas.php" style="padding: 10px 11px 10px 20px;">ACCESORIOS</a></li>
                        <li class="u-nav-item"><a class="u-button-style u-nav-link u-text-active-white u-text-hover-white" href="alimentos.php" style="padding: 10px 11px 10px 20px;">ALIMENTOS</a></li>
                        <li class="u-nav-item"><a class="u-button-style u-nav-link u-text-active-white u-text-hover-white" href="medicamentos.php" style="padding: 10px 11px 10px 20px;">MEDICAMENTOS</a></li>
        ...
        <div class="u-clearfix u-sheet u-sheet-1">
            <h1 class="u-custom-font u-font-oswald u-text u-text-default u-text-palette-3-base u-text-1">
                <span class="u-text-palette-1-base">
                    <font color="#193a77">Alimentos</font>
                </span>
            </h1>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div id="products" class="row list-group">
                                <?php
                                //get rows query
                                $query = $db->query("SELECT * FROM productos where categoria_id=2");
                                if ($query->num_rows > 0) {
