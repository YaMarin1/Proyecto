        ...
        <nav class="u-menu u-menu-dropdown u-offcanvas u-menu-1" data-responsive-from="MD">
          ...
          <div class="u-custom-menu u-nav-container">
            <ul class="u-nav u-unstyled u-nav-1">
              ...
              <li class="u-nav-item"><a class="u-button-style u-nav-link u-text-active-white u-text-hover-white" href="Alimentos.html" style="padding: 10px 11px 10px 20px;">ALIMENTOS</a>
</li><li class="u-nav-item"><a class="u-button-style u-nav-link u-text-active-white u-text-hover-white" href="" style="padding: 10px 11px 10px 20px;">MEDICINAS</a>
</li><li class="u-nav-item"><a class="u-button-style u-nav-link u-text-active-white u-text-hover-white" href="" style="padding: 10px 11px 10px 20px;">ACCESORIOS</a>
</li><li class="u-nav-item"><a class="u-button-style u-nav-link u-text-active-white u-text-hover-white" href="" style="padding: 10px 11px 10px 20px;">CARRITO</a>
</li></ul>
          </div>
